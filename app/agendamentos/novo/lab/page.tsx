...
export default function NovoAgendamentoLab() {
  ...
  async function carregarAgenda(
    ...
    try {
      ...
      console.error('Erro ao carregar agenda do Lab. de Ciências:', err)
      setAgendamentos([])
    } finally {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (conflito) {
        alert('O Lab. de Ciências já está reservado nesse horário.')
        return
      }
      ...
      await criarEventoGoogleAgenda({
        titulo: `Agendamento Lab. de Ciências - ${turmaClasse}`,
        descricao: [
          `Recurso: Lab. de Ciências`,
          `Turma: ${turmaClasse}`,
      ...
      alert('Agendamento do Lab. de Ciências realizado com sucesso!')
    } catch (err: any) {
      console.error('Erro completo ao salvar Lab. de Ciências:', err)
      ...
      <div className="max-w-5xl mx-auto py-16 px-4">
        ...
        <div className="flex flex-col xl:flex-row xl:items-end xl:justify-between gap-6 mb-8">
          <div className="w-full xl:max-w-[420px]">
            <h1 className="text-3xl font-bold">Agenda do Lab. de Ciências</h1>
        ...
        {mostrarFormulario ? (
          <div ref={formRef} className="mt-12">
            <h2 className="text-2xl font-bold mb-6">
              Novo agendamento — Lab. de Ciências
            </h2>
